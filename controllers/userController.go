...
import (
	"Restaurent-Management-System/database"
	helper "Restaurent-Management-System/helpers"
	"Restaurent-Management-System/models"
	"context"
	"fmt"
	"log"
	"net/http"
...
func SignUp() gin.HandlerFunc {
	return func(c *gin.Context) {
		//convert json data, validate and check any duplicate data
		//hash pass, extra details (created at/updated at)
		...
		if count > 0 {
			c.JSON(http.StatusInternalServerError, gin.H{"error": "this email or phone already used"})
			return 
		}
